...
print('SEMANTICO')
print()
print('\n'.join(list(map(''.join, txt))))
if(cont) : print("Alguna sintaxis no es valida\n")
else : print("Ejecucion exitosa\n")

print('SEMANTICO')
#IMPRESION DEL RESULTADO DE LA EJECUCION
print (txt [0])
print ("Alguna sintaxis no es valida")

print("\n")
list_A = 'DIMAS NAHUAT HERRERA'
print("INTEGRANTES: ", list_A, "")
list_B=  'DALIA ABIGAIL CHI POOT '
print(list_B, "")
lista_C= 'JOSE ADALBERTO TUZ AY'
print(lista_C , "")
